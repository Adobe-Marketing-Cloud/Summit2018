...
@Model(adaptables = SlingHttpServletRequest.class, resourceType = SimpleListModelExporter.LIST_RESOURCE_TYPE,
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, adapters = {ComponentExporter.class, SimpleListModelExporter.class})
@Exporter(name = "jackson", extensions = "json", options = {
        @ExporterOption(name = "MapperFeature.SORT_PROPERTIES_ALPHABETICALLY", value = "true"),
        @ExporterOption(name = "SerializationFeature.WRITE_DATES_AS_TIMESTAMPS", value="false")
})
@JsonInclude(JsonInclude.Include.NON_NULL)
public class SimpleListModelExporter implements ContainerExporter, ComponentExporter {
